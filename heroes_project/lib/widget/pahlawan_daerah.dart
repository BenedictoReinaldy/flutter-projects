                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        radius: 50,
                        backgroundImage: AssetImage('assets/images/sutomo.jpg'),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 5.0),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        radius: 50,
                        backgroundImage: AssetImage('assets/images/dien.jpeg'),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 5.0),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        radius: 50,
                        backgroundImage: AssetImage('assets/images/yamin.jpg'),
                      ),
                      Padding(
                        padding: EdgeInsets.only(top: 5.0),
